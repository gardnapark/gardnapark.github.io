...
sub success_page_html_preamble {
  ...
  my $title = $self->escape_html( $self->{FormConfig}{'title'} || 'Wysłano' );
...
END
  ...
  <body style="font-family: 'Lora', serif;" $attr>
    <h1 class="title">Wysłano wiadomość</h1>
	<h2 class="title nav justify-content-center">Dziękujemy</h2>
	<hr size="1" width="75%" />
	<div class="nav justify-content-center">
	
	<a class="btn btn-success" href="http://www.gardnapark.pl">Powrót do Gardna Park</a>
	</div>
