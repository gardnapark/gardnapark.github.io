...
sub success_page_html_preamble {
  ...
  my $title = $self->escape_html( $self->{FormConfig}{'title'} || 'Sent' );
...
END
  ...
  <body style="font-family: 'Lora', serif;" $attr>
	...
	<h2 class="title nav justify-content-center">Thank you</h2>
	<hr size="1" width="75%" />
	<div class="nav justify-content-center">
	
	<a class="btn btn-success" href="http://www.gardnapark.pl/en/index.html">Return to Gardna Park</a>
	</div>
